...
#  String-Sortable customized version 0.01 hma Sep 22, 2010
#
...
# Encode required by t/04-utf8.t which is run only by Perl 5.8 and newer
# Test::Pod and Test::Pod::Coverage required by the hacks for Kwalitee
# in xt/pod.t and xt/pod-coverage.t

$used->push_exclude_in_testdir( 'Encode', 'Test::Pod', 'Test::Pod::Coverage' );
